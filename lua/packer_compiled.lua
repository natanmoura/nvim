...
_G.packer_plugins = {
  ...
  ["pounce.nvim"] = {
    loaded = true,
    path = "/home/natanmoura/.local/share/nvim/site/pack/packer/start/pounce.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'gitsigns.nvim', 'nvim-lsp-installer', 'nvim-lspconfig', 'nvim-cmp', 'null-ls.nvim', 'lspsaga.nvim', 'nvim-colorizer.lua', 'nvim-treesitter', 'neoscroll.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
